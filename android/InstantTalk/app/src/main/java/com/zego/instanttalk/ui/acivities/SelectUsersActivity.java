...
public class SelectUsersActivity extends AbsBaseActivity {
    ...
    protected void initVariables(Bundle savedInstanceState) {
        if(mChatType == Constants.CHAT_TYPE_TEXT){
            ...
            mSelectUsersAdapter = new SelectUsersAdapter(this, UserListPresenter.getInstance().getUserList(), 2);
        }
        ...
        mSelectUsersAdapter.setOnUserSelectListener(new SelectUsersAdapter.OnUserSelectListener() {
            ...
            @Override
            public void onPeopleCountExceedLimit() {
                Toast.makeText(SelectUsersActivity.this, getString(R.string.only_n_friends_can_be_invited_one_time, "2"), Toast.LENGTH_SHORT).show();
            }
        });
    }
