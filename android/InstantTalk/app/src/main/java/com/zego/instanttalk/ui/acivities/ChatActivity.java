...
public class ChatActivity extends AbsBaseActivity {
        ...
        BizLivePresenter.getInstance().setVideoTalkView(new VideoTalkView() {
            ...
            public void onCancelChat() {
                ...
                if (mDialogHandleRequestPublish != null && mDialogHandleRequestPublish.isShowing()) {
                    ...
                    Toast.makeText(ChatActivity.this, getString(R.string.your_friend_has_canceled_the_chat), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onShowRequestMsg(final List<BizUser> listToUser, final String magic, final long roomKey, String fromUserName) {
                mDialogHandleRequestPublish = new AlertDialog.Builder(ChatActivity.this).setTitle(getString(R.string.hint)).
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                PublishActivity.actionStart(ChatActivity.this, arrayList, roomKey);
                                dialog.dismiss();
                                finish();
                            }
    ...
    public void sendMsg() {
        ...
        if (TextUtils.isEmpty(msg)) {
            Toast.makeText(ChatActivity.this, R.string.you_can_not_send_an_empty_message, Toast.LENGTH_SHORT).show();
            return;
        }
        etMsg.setText("");
    ...
    public void startVideoChat() {
        if (mListToUser.size() > 2) {
            ...
            PlayActivity.actionStart(this, listUser);
        } else {
            PlayActivity.actionStart(this, mListToUser);
        }
        finish();
    }
